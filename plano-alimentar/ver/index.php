				            ...
				            <div class="module">
				                ...
				                <div class="row" data-index="<?php echo $i ?>" data-refeicao="coffee" id="alimento-coffee<?php if ($i != 1) { echo '-' . $i; } ?>">
				                    <div class="col-7">
				                        ...
				                        <input list="alimentos" class="alimentoNome" type="text" placeholder="ex: Frango" value="<?php echo $coffee['alimento'] ?>" name="coffee[<?php echo $i ?>][alimento]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Porções: (100g)</label>
				                        <input class="porcao" type="number" value="<?php echo $coffee['porcao'] ?>" name="coffee[<?php echo $i ?>][porcao]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Calorias:</label>
				                        <input class="calorias" type="text" value="<?php echo $coffee['calorias'] ?>" name="coffee[<?php echo $i ?>][calorias]">
				                    </div>
				                    <div style="text-align: right !important;" class="col-1">
				                        <button onclick="btnActApagar(this)" data-refeicao="coffee" data-index="<?php echo $i ?>" type="button" style="margin-top: 7px;" class="trash-button coffee act border_color ">
				        ...
				        <div style="margin-top: 10px;" class="col-12">
				            <div class="module">
				                ...
				                <div class="row" data-index="<?php echo $i ?>" data-refeicao="almoco" id="alimento-almoco<?php if ($i != 1) { echo '-' . $i; } ?>">
				                    <div class="col-7">
				                        <label class="input">Alimento:</label>
				                        <input list="alimentos" class="alimentoNome" type="text" placeholder="ex: Frango" value="<?php echo $almoco['alimento'] ?>" name="almoco[<?php echo $i ?>][alimento]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Porções: (100g)</label>
				                        <input class="porcao" type="number" value="<?php echo $almoco['porcao'] ?>" name="almoco[<?php echo $i ?>][porcao]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Calorias:</label>
				                        <input class="calorias" type="text" value="<?php echo $almoco['calorias'] ?>" name="almoco[<?php echo $i ?>][calorias]">
				                    </div>
				                    <div style="text-align: right !important;" class="col-1">
				                        <button onclick="btnActApagar(this)" data-refeicao="almoco" data-index="<?php echo $i ?>" type="button" style="margin-top: 7px;" class="trash-button almoco act border_color ">
				                            <svg style="margin-right: 0px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
				                                <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"></path>
				                            </svg>
				                        </button>
				        ...
				        <div style="margin-top: 10px;" class="col-12">
				            <div class="module">
				                ...
				                <div class="row" data-index="<?php echo $i ?>" data-refeicao="jantar" id="alimento-jantar<?php if ($i != 1) { echo '-' . $i; } ?>">
				                    <div class="col-7">
				                        <label class="input">Alimento:</label>
				                        <input list="alimentos" class="alimentoNome" type="text" placeholder="ex: Frango" value="<?php echo $jantar['alimento'] ?>" name="jantar[<?php echo $i ?>][alimento]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Porções: (100g)</label>
				                        <input class="porcao" type="number" value="<?php echo $jantar['porcao'] ?>" name="jantar[<?php echo $i ?>][porcao]">
				                    </div>
				                    <div class="col-2">
				                        <label class="input">Calorias:</label>
				                        <input class="calorias" type="text" value="<?php echo $jantar['calorias'] ?>" name="jantar[<?php echo $i ?>][calorias]">
				                    </div>
				                    <div style="text-align: right !important;" class="col-1">
									<button onclick="btnActApagar(this)" data-refeicao="jantar" data-index="<?php echo $i ?>" type="button" style="margin-top: 7px;" class="trash-button jantar act border_color ">
									    <svg style="margin-right: 0px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
									        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"></path>
									    </svg>
									</button>
